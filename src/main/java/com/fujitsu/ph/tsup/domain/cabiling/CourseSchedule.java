	    ...
	    public static class Builder {
	        ...
	        private void validateInstructorId(Long InstructorId) {
	            if (InstructorId == null) {
	                throw new IllegalArgumentException("Insructor Id cannot be null");
	            }
	        }
	        ...
	        private void validateMinRequired(int MinRequired) {
	            if (MinRequired <= 0) {
	                ...
	                throw new IllegalArgumentException("Min Required should not be greater than 1000");
	            } else if (String.valueOf(MinRequired).equals(null)) {
	                throw new NullPointerException("Min Required cannot be null.");
	            }
	        }
	        
	        private void validateMaxAllowed(int MaxAllowed) {
	            if (MaxAllowed <= 0) {
	                throw new IllegalArgumentException("Max Allowed cannot be less than or equal to zero, greater than 99999 or null.");
	            } else if (MaxAllowed > 1000) {
	                throw new IllegalArgumentException("Max Allowed cannot be greater than 1000.");
	            } else if (String.valueOf(MaxAllowed).equals(null)) {
	                throw new IllegalArgumentException("Max Allowed cannot be null.");
	            }
	        }
	        
	        private void validateStatus(char Status) {
	            if (Status == '\u0000') {
	                throw new IllegalArgumentException("Status should not be a null.");
