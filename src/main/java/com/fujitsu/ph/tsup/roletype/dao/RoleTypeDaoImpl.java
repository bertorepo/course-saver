...
public class RoleTypeDaoImpl implements RoleTypeDao{
	...
	public void createRoleType(RoleType role) {
		String query = "INSERT INTO MEMBER_ROLE"
				+ "(role_type, role_desc)"
				+ "VALUES (:rolename , :roledesc)";
		SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
				.addValue("rolename", role.getRolename())
				.addValue("roledesc", role.getRoledesc());
	...
	public void updateRoleType(RoleType roleType) {
	    ...
	    SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
	    		.addValue("role_name", roleType.getRolename())
	            .addValue("role_desc", roleType.getRoledesc());
