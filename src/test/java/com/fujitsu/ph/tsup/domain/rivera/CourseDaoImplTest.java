...
public class CourseDaoImplTest {
    ...
    @Test
    void test() {
        Course courseOne = new Course.Builder("Course1").build();
        courseDao.save(courseOne);
        Long crsOne = courseDao.saveCourse();
 
        Course courseTwo = new Course.Builder("Course2").build();
        ...
        assertEquals("Course1", dbCourseOne.getCourseName());
        ...
        assertEquals("Course2", dbCourseTwo.getCourseName());
