...
public class CourseServiceImplTest {
    ...
    void testSave() {
        ...
        assertEquals(Course.getId(), 654321L);
        assertEquals(Course.getName(), "JUnit");
    }
    ...
    void testSaveEx() {
        ...
        String expectedMessage = "Course Id should not be equal to or less than zero.";
    ...
    void testFindById() {
        ...
        Course Course = courseService.findById(654321L);
...
;
    ...
    private Course createCourse() {
        return new Course.Builder(654321L, "JUnit").builder(); 
    }
    
    private Course createErrCourse() {
       return new Course.Builder(0L, "Java").builder();
    }
