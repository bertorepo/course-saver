...
public class CourseScheduleServiceImplTest {
    ...
    public void testFindById() {
        when(courseScheduleDao.findById(anyLong())).thenReturn(createCourseScheduleFindById());
    ...
    public void testFindByIdErr() {
        when(courseScheduleDao.findById(anyLong())).thenReturn(createCourseScheduleFindByIdErr());
        CourseSchedule c = service.findById((long) 1);
        assertEquals(c.getStatus(), "C");
    }
