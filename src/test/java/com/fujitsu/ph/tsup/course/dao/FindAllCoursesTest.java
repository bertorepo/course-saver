...
//Class Name: FindAllCoursesTest.java
//
...
class FindAllCoursesTest {
     ...
     * courseManagementDao.findAllCourses and test if the methods find all the courses
     * <pre>
     */
	@Test
	void testFindAllCourses() {
		Set<Course> courseSet = courseManagementDao.findAllCourses();
