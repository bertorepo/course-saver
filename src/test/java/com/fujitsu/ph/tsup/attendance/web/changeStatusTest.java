...
public class changeStatusTest {
        ...
        void testChangeStatus() throws Exception {
            ...
            .andExpect(model().attributeExists("changeAttendanceStatus"))
            .andExpect(model().attributeDoesNotExist("errorMessages"))
            .andExpect(model().attribute("changeAttendanceStatus",hasProperty("courses",
                    containsInAnyOrder(hasProperty("courseName",is(courseAttendance.getCourseName()
                            + " | " + courseAttendance.getScheduleStartDateTime() + " --- "
                            + courseAttendance.getScheduleEndDateTime()))))))
            .andExpect(model().attribute("changeAttendanceStatus",hasProperty("participants",
