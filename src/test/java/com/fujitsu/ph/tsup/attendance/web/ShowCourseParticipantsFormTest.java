...
//Class Name   :ShowCourseParticipantsFormTest.java
//
...
/**
* <pre>
* The Show Course Participants Form Test for controller.
...
public class ShowCourseParticipantsFormTest {
        ...
        mockMvc.perform(get("/attendance/schedules/{courseScheduleId}/participants", 2L)).andDo(print())
                ...
                .andExpect(model().attribute("courseParticipant", 
                        hasProperty("courseScheduleDetails",
                                ...
                                is(courseParticipant.getDuration()))))))
                .andExpect(model().attribute("courseParticipant",
