...
//Class Name   :FindCourseScheduleDetailParticipantsByIdTest.java
//
...
/**
* <pre>
* The Find Course Schedule Detail Participants By Id Test for Dao.
...
public class FindCourseScheduleDetailParticipantsByIdTest {
     ...
     * Call attendanceDao.findCourseScheduleDetailParticipantsById and test if 
     * course schedule detail participant is retrieving data from the database
     * 
     * </pre>
     */
    @Test
    void testFindCourseScheduleDetailParticipantsById() {
        Set<CourseAttendance> courseAttendanceSet = attendanceDao.findCourseScheduleDetailParticipantsById(1L);
        ...
        for(CourseAttendance courseAttendance : courseAttendanceSet) {
            ...
            assertNotSame("Abad, Kenneth", courseAttendance.getParticipantName());
        }
    }
}
